...
# run model
fit_model_h2a <- sem(model = model_h2a, data = data_scaled,
                     estimator = "MLR" , missing = "fiml",
                     std.lv = FALSE)
# get model statistics
summary(fit_model_h2a, fit.measures = TRUE,
        standardized = TRUE, rsquare = TRUE, ci = TRUE)
```

```{r standardised-solution-h2a}
standardizedSolution(fit_model_h2a)
```

```{r mod-indices-h2a}
mi <- modindices(fit_model_h2a)
