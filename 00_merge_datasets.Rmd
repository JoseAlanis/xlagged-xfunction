...
alpha_wm.p_t1$total %>%
        ...
        kbl(digits = 3,
            caption = 'Iternal consitency, working memory items at measurement timepoint 1') %>%
        kable_classic("hover", full_width = FALSE)
```
...
alpha_wm.p_t2$total %>%
        ...
        rename(Target = target,
               ...
               M = mean, SD = sd, Median_r = median_r) %>%
        kbl(digits = 3,
            caption = 'Iternal consitency, working memory items at measurement timepoint 2') %>%
        kable_classic("hover", full_width = FALSE)
```
...
alpha_inhibition.p_t1$total %>%
        ...
        rename(Target = target,
               ...
               M = mean, SD = sd, Median_r = median_r) %>%
        kbl(digits = 3,
            caption = 'Iternal consitency, inhibition items at measurement timepoint 1') %>%
        kable_classic("hover", full_width = FALSE)
```
...
alpha_inhibition.p_t2$total %>%
        ...
        rename(Target = target,
               ...
               M = mean, SD = sd, Median_r = median_r) %>%
        kbl(digits = 3,
            caption = 'Iternal consitency, inhibition items at measurement timepoint 2') %>%
        kable_classic("hover", full_width = FALSE)
```
